...
· 프론트엔드 4명으로 이루어진 팀과 백엔드 개발자 1명의 협업으로 만들어진
  사이트이며, api 통신을 통해 로그인/회원가입, 데이터 CRUD가 가능합니다.

· recoil을 통해 로그인 전역상태관리를 하였고, 사용자 경험을 고려한
  직관적인 UI / UX를 구현하였습니다.
`;
const links = {
...
const contribute = `· 각 팀원 데일리 테스크 트래킹/리마인더를 담당하였습니다. 

· 일정보다 일찍 프로젝트를 마무리하고, 전체 폴더구조 개선 & 리팩토링 & 테스트를 진행하였습니다. 
    ...
    <>
      ...
      <section className={styles.main}>
        ...
        <article className={styles.contributeArticle}>
          ...
          <p className={styles.contribute}>{contribute}</p>
        </article>

        <h2>검색페이지</h2>

        <article className={styles.searchArticle}>
          <p>{descriptionObj.search}</p>
